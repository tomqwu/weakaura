# Paladin — TBC WeakAuras (All Specs v25)
...
## v25 — the blank slot in the alert column

The player: *"why there is an empty one?"* — an alert rendering as an empty bordered square, no
art at all. It was **`RE-SEAL`**, and it was the only alert in the pack still resolving its icon
with `iconSource = 2`.

That form reads `states[2].icon` — trigger 2's own state — and `states[N]` for a trigger that
is not the *active* one is not reliably populated in the `/wa` preview. It is the exact
mechanism that gave the rogue rotation lane its question marks (rogue v63), and RE-SEAL was
built two versions before that lesson was learned. Worse, v17's own build assertion **defended
the broken form**, on the reasoning that resolving from the trigger beats hard-coding a path.
The goal was right; the form was wrong.

**Fixed the way the lane was fixed:** `iconSource = -1` reads `state.icon`, and
`activeTriggerMode = 2` names the Seal of Command trigger as the state provider. Which trigger
owns state does not decide visibility — that is `customTriggerLogic`'s job — so nothing about
*when* RE-SEAL fires changes, only whether it has a face. A literal fallback goes on underneath
as a floor, the way every CC prompt now carries one; it is the same art `Twist NOW` already
proves renders, and the two prompts are halves of one cycle.

**Then the whole repo was swept for the same form.** Four hunter auras carried it —
Misdirection Prompt, Mend Pet, Revive Pet, SILENCE NOW — and are moved to the reliable form in
hunter v20. An audit now reports **zero** icon auras that can render blank across all seven
packs.

## v24 — 审判 and 十字军打击 move to the left

The player: *"审判和十字军打击应该是在左边的，下面一排主要是长CD技能"* — Judgement and Crusader
Strike belong on the left; the bottom row should be long cooldowns. Right on both counts: a 10s
and a 6s **rotational** button were sitting in a row of 1-to-60-minute cooldowns, glowing most
of the fight, while the "what do I press" surface this repo builds is the left side.

**`Paladin - Rotation`** is the rogue lane pattern: a one-slot dynamic group at (−150, −96),
directly below the alert column, `limit = 1` so it draws only the **top pressable priority**:

| rank | shown when | spec |
|---|---|---|
| **JUDGEMENT** | usable (mana included) + hostile target | Prot & Ret (not deep Holy — the v4 reasoning stands) |
| **CRUSADER STRIKE** | usable + hostile target, and Judgement is down | Ret |

Judgement outranks Crusader Strike because it is off the GCD and drives the seal cycle: when
both are ready, the correct press is Judgement, and the slot says exactly that.

**Pressable, not merely off cooldown.** Visibility runs through `Action Usable` —
`IsUsableSpell(spellName) and ready` — so mana is included, the prompt clears the instant you
press, and the 6s/10s cooldown keeps it away until the next real decision. This is the same
semantics the rogue lane adopted at v66 at the player's request.

**The two icons are the existing row auras, moved** — re-parented, renamed
(`Paladin CD - X` → `Paladin Now - X`), resized to the alert column's 40px and given its exact
`slidebottom`/slide-up-fade treatment, all uid-free. Only the lane group is new: one appended
`uid()`, 45 auras → 46. The lane canon asserts the ranks field-by-field **against
`Paladin - HAMMER NOW`** rather than against literals, so the lane and the alert column cannot
drift apart — the rogue v66 lesson, applied on arrival.

**What the bottom row is now:** Consecration, Hammer of Justice, Avenging Wrath, Divine Shield,
Lay on Hands, Holy Shock, Divine Favor, Divine Illumination, Avenger's Shield, and the three
PvP-gated entries — long cooldowns and situational buttons. The one deliberate exception is
**Consecration** (8s): it stays in the row because it is Protection's press-on-cooldown threat
button and the row's glow idiom serves it well; say the word and it joins the lane for Prot.
...
```
